...
const Contact = ({ingles}) => {

    return (
        <div className="container_contact">
            <h2 data-aos="flip-right" data-aos-delay="500" data-aos-duration="1000">{ingles ? 'CONTACT' : 'CONTACTO'}</h2>
            <div className="linea" data-aos="fade-down" data-aos-delay="600" data-aos-duration="1000"></div>
            <p data-aos="fade-down" data-aos-delay="1000" data-aos-duration="1000">
                {ingles ? 'Do you have a question or want to work together?' : '¿Tienes alguna pregunta o quieres que trabajemos juntos?'}
            </p>
